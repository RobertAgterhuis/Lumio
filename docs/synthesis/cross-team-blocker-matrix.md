...
| BLK-009 | Marketing | UX | **Shamir UX test results** — marketing claim "In één middag alles op orde" is contradicted by Phase 3 GAP-UX-001 (7-step wizard, cognitive load 8/10). Claim cannot be validated until BLOCKING-P3-001 (Shamir UX test, 5 participants) is executed. Source: RISK-MKT-004, phase3-critic-risk-validation.md. | BLOCKING | HIGH | Execute Shamir UX test per `devdocs/shamir-ux-test-protocol.md`. UX Lead owner. |
...
| BLK-009: Shamir UX test scheduling | UX Lead | Sprint 1 |
