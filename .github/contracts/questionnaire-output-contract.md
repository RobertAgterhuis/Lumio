...
The Questionnaire Agent MUST update `questionnaire_answer_summary` in the session state after answer loading (see `docs/contracts/session-state-contract.md`).
...
- [ ] Output complies with docs/guardrails/09-questionnaire-guardrails.md
