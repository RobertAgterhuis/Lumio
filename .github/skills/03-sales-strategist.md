...
- Conversion and pipeline analysis
- Sales-product alignment assessment
- Identification of sales friction points
...
### Step 5: Competitive Landscape (Sales Perspective)
...
- `docs/guardrails/01-business-guardrails.md` (specifically G-BUS-03, G-BUS-07)
...
- [ ] ICP defined based on data (or INSUFFICIENT_DATA: for all fields)
- [ ] Sales cycle fully documented with all steps
- [ ] Conversion metrics documented (or INSUFFICIENT_DATA:)
- [ ] Sales-product alignment analysis complete
