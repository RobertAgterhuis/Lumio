...
public class ExportController : ControllerBase
{
    ...
    /// <summary>
    /// Returns a boolean flag per export module indicating whether that module has any data.
    /// Used by the frontend to show "Geen data" warnings without blocking downloads.
    /// </summary>
    [HttpGet("status")]
