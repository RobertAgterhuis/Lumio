      ...
      <section className="py-16 bg-[var(--color-primary-50)] border-t border-[var(--color-primary-100)]">
        <Container narrow>
          <div className="text-center">
            <h2 className="font-display text-2xl text-[var(--color-neutral-900)] mb-3">
              Liever direct contact?
            </h2>
            <p className="text-[var(--color-neutral-600)] mb-6">
              Stuur een e-mail naar{" "}
              <a href="mailto:info@lumio.app" className="text-[var(--color-primary-700)] font-semibold hover:underline">
                info@lumio.app
              </a>{" "}
