    ...
    <footer className="bg-primary-900 text-primary-200">
      <Container>
        <div className="py-12">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-col gap-2">
                <Link
                  href="/voor-jezelf"
                  className="inline-block rounded-sm bg-(--color-primary-600) px-4 py-2 text-sm font-semibold text-white hover:bg-primary-500 transition-colors text-center"
                >
                  Koop voor jezelf →
                </Link>
                <Link
                  href="/contact"
                  className="inline-block rounded-sm border border-(--color-primary-600) px-4 py-2 text-sm font-semibold text-primary-200 hover:bg-primary-800 transition-colors text-center"
                >
          ...
          <div className="mt-12 border-t border-primary-800 pt-6 flex flex-col sm:flex-row justify-between gap-3">
