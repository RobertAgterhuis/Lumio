      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[var(--color-neutral-600)]">
              {[
                ...
                <li key={item} className="flex gap-3">
                  <span className="mt-1 flex-shrink-0 w-5 h-5 rounded-full bg-[var(--color-primary-100)] flex items-center justify-center">
                    <svg className="w-3 h-3 text-[var(--color-primary-700)]" fill="currentColor" viewBox="0 0 12 12">
          ...
          <div className="rounded-2xl overflow-hidden bg-[var(--color-primary-50)] border border-[var(--color-primary-100)] aspect-[4/3] flex items-center justify-center">
            <div className="text-center text-[var(--color-primary-500)] p-8">
