...
- **Technische documentatie:** zie [`docs/NL/technical-manual`](docs/NL/technical-manual)
- **Gebruikershandleiding:** zie [`docs/NL/user-manual`](docs/NL/user-manual)
...
- **Technical documentation:** see [`docs/EN/technical-manual`](docs/EN/technical-manual)
- **User manual:** see [`docs/EN/user-manual`](docs/EN/user-manual)
