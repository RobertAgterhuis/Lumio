...
- **Technische documentatie:** zie [`docs/NL/technical-manual`](docs/technical-manual)
- **Gebruikershandleiding:** zie [`docs/NL/user-manual`](docs/user-manual)
...
- **Technical documentation:** see [`docs/EN/technical-manual`](docs/technical-manual)
- **User manual:** see [`docs/EN/user-manual`](docs/user-manual)
